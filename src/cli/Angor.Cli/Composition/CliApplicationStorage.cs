...
/// <summary>
/// Application storage for CLI mode. Identical to the design app's AppApplicationStorage.
/// Stores wallet data under %LOCALAPPDATA%/Angor.
/// </summary>
public class CliApplicationStorage : IApplicationStorage
{
