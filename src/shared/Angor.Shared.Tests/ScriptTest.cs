...
namespace Angor.Test
{
    public class ScriptTest
    {
        ...
        public void BuildStageScriptsSeeder()
        {
            ...
            var scripts = ScriptBuilder.BuildScripts(funderKey.PubKey.ToHex(), funderRecoveryKey.PubKey.ToHex(), investorKey.PubKey.ToHex(), Hashes.DoubleSHA256(secret.ToBytes()).ToString(), DateTime.UtcNow, DateTime.UtcNow.AddDays(1), projectSeeders);
