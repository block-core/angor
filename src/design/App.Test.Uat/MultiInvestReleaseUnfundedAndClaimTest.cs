...
/// <summary>
/// Per-process UAT version of the integration MultiInvestReleaseUnfundedAndClaimTest.
/// Invest project: 1 founder + 2 investors.
/// Founder claims stage 1, releases remaining stages, investors claim via unfunded-release.
/// Identical flow to MultiInvestClaimAndRecoverTest but with different test name for parity
/// with the integration project structure.
/// </summary>
