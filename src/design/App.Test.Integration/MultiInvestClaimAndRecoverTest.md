...
- Founder profile: `MultiInvestClaimAndRecover-Founder`
- Investor1 profile: `MultiInvestClaimAndRecover-Investor1`
- Investor2 profile: `MultiInvestClaimAndRecover-Investor2`
...
3. Investor 1 invests `0.001 BTC`.
...
```bash
dotnet test "src/design/App.Test.Integration/App.Test.Integration.csproj" --filter "FullyQualifiedName~MultiInvestClaimAndRecoverTest"
```

Verbose:

```bash
dotnet test "src/design/App.Test.Integration/App.Test.Integration.csproj" --filter "FullyQualifiedName~MultiInvestClaimAndRecoverTest" --logger "console;verbosity=detailed"
```
