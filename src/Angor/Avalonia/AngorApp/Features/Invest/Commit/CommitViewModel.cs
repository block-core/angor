...
{
    public CommitViewModel(IInvestmentAppService investmentAppService, UI.Services.UIServices uiServices, IWallet wallet, IProject project, CreateInvestment.Draft draft)
    {
