...
public partial class SeedWordsViewModel : ReactiveValidationObject, ISeedWordsViewModel
{
    ...
    public IObservable<bool> IsValid => this.WhenAnyValue<SeedWordsViewModel, bool, bool, Maybe<WordList>>(x => x.AreWordsWrittenDown, x => x.Words, (written, maybeWords) => written && maybeWords.HasValue);
