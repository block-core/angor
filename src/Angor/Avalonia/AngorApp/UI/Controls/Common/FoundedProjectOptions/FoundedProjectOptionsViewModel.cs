...
public class FoundedProjectOptionsViewModel : IFoundedProjectOptionsViewModel
{
    ...
    public FoundedProjectOptionsViewModel(ProjectId projectId, IInvestmentAppService investmentAppService, UIServices uiServices, INavigator navigator, IWalletContext walletContext)
    {
        ...
        ProjectInvestment = LoadInvestment.Successes().Values()
            .Select(dto => new PortfolioProjectViewModel(dto, investmentAppService, uiServices, navigator, walletContext));
