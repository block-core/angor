...
{
    Task<List<NostrEventResponse>> GetEventsAsync(string subscriptionId, NostrKind[] kinds,
        string[]? receiversPubkeys = null, string[]? sendersPubkeys = null, string[]? eventIds = null);
