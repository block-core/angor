...
public class RequestInvestment
{
        ...
        IRelayService relayService) : IRequestHandler<RequestFounderSignaturesRequest, Result<Guid>>
    {
        ...
        {
            var txnHex = requestFounderSignaturesRequest.Draft.SignedTxHex;
    ...
    public class RequestFounderSignaturesRequest(ProjectId projectId, CreateInvestment.Draft draft) : IRequest<Result<Guid>>
    {
