...
public interface IProjectAppService
{
    ...
    Task<Result<CreateProjectProfileResponse>> CreateProjectProfile(WalletId walletId, CreateProjectDto project);
    Task<Result<CreateProjectInfoResponse>> CreateProjectInfo(WalletId walletId, CreateProjectDto project, FounderKeys FounderKeys);
    Task<Result<TransactionDraft>> CreateProject(WalletId walletId, long selectedFee, CreateProjectDto project, string projectInfoEventId, FounderKeys FounderKeys);
