...
/// <summary>
/// Application storage implementation for Avalonia2.
/// Mirrors AngorApp's ApplicationStorage but uses "Avalonia2" as the app name.
/// </summary>
public class Avalonia2ApplicationStorage : IApplicationStorage
{
