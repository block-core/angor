...
namespace Angor.Shared.Services
{
    public class RelayService : IRelayService
    {
            ...
            int outputIndex, decimal amount, Action<NostrOkResponse> onResponse)
        {
            ...
            if (!_subscriptionsHandling.TryAddOKAction(signedEvent.Id, onResponse))
            {
                throw new InvalidOperationException($"Failed to monitor relay results for event {signedEvent.Id}");
            }
