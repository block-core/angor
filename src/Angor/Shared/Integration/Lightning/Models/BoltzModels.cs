<<<<<<<< HEAD:src/Angor/Shared/Integration/Lightning/Models/BoltzModels.cs
...
{
    /// <summary>Unique identifier for this swap</summary>
    public string Id { get; set; } = string.Empty;

    /// <summary>Lightning invoice (BOLT11) that the user needs to pay</summary>
    ...
    /// <summary>Expected amount in satoshis to be received on-chain (after fees)</summary>
    public long ExpectedAmount { get; set; }

    /// <summary>Amount the user needs to pay via Lightning</summary>
    public long InvoiceAmount { get; set; }

    /// <summary>Timeout block height for the swap</summary>
    public long TimeoutBlockHeight { get; set; }

    /// <summary>Redeem script for the swap HTLC (legacy, use SwapTree for Taproot)</summary>
    public string RedeemScript { get; set; } = string.Empty;

    /// <summary>Swap tree for Taproot scripts (serialized JSON)</summary>
    public string SwapTree { get; set; } = string.Empty;

    /// <summary>Boltz's refund public key (needed for MuSig2 claim)</summary>
    public string RefundPublicKey { get; set; } = string.Empty;

    /// <summary>Our claim public key (the one we sent when creating the swap)</summary>
    public string ClaimPublicKey { get; set; } = string.Empty;

    /// <summary>Blinding key for Liquid swaps (null for BTC)</summary>
    public string? BlindingKey { get; set; }

    /// <summary>BIP21 payment URI (if available)</summary>
    ...
    /// <summary>SHA256 hash of the preimage, sent to Boltz when creating the swap</summary>
...
{
    /// <summary>Percentage fee (e.g., 0.5 means 0.5%)</summary>
    public decimal Percentage { get; set; }

    /// <summary>Fixed miner fee in satoshis</summary>
    ...
    /// <summary>Calculates the on-chain amount that will be received for a given invoice amount.</summary>
    ...
    /// <summary>Gets the total fees that will be deducted for a given invoice amount.</summary>
...
/// <summary>Current status of a swap</summary>
...
/// <summary>Swap state enum matching Boltz API states</summary>
...
/// <summary>Extension methods for swap states</summary>
...
>>>>>>>> 2f47cc51 (Refactor Boltz integration: move models and services to Angor.Shared.Integration.Lightning namespace):src/Angor/Avalonia/Angor.Sdk/Integration/Lightning/Models/BoltzModels.cs
