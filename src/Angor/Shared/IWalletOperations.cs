...
namespace Angor.Shared
{
    public interface IWalletOperations
    {
        ...
        Task<(string address, List<UtxoData> data)> FetchUtxoForAddressAsync(string address);
        ...
        TransactionInfo AddInputsAndSignTransaction(string changeAddress, Transaction transaction, WalletWords walletWords, AccountInfo accountInfo, FeeEstimation feeRate);
        Task<OperationResult<Transaction>> PublishTransactionAsync(Network network, Transaction signedTransaction);
        TransactionInfo AddFeeAndSignTransaction(string changeAddress, Transaction transaction, WalletWords walletWords, AccountInfo accountInfo, FeeEstimation feeRate);
