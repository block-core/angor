...
{
    static NBitcoin.Network _nbitcoinNetwork = NetworkMapper.Map(Networks.Bitcoin.Testnet());
    ...
    public static void ThanTheTransactionHasNoErrors(Transaction trx, IEnumerable<Coin>? coins = null)
    {
        ...
        var nBitcoinTrx = NBitcoin.Transaction.Parse(trx.ToHex(), _nbitcoinNetwork);
