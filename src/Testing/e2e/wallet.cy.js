...
describe("walletSpec", {retries: 1}, () => { // changed for 1 - temp for testing
    beforeEach(() => {
        cy.visitLocalhost();
    });
    ...
    it("createWallet", () => {
        ...
        cy.get("textarea.form-control[readonly]")
            ...
            .then((walletWords) => {
                ...
                cy.clickElementWithDataCy(WALLET_DATA_CY.CREATE_WALLET_MOUDLE); 
                ...
                cy.clickAndTypeElementWithDataCy(WALLET_DATA_CY.PASSWORD_SHOW_WORDS, "abc123");
                cy.clickElementWithDataCy(WALLET_DATA_CY.PASSWORD_SHOW_WORDS);
